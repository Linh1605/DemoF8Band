        ...
        <div class="content">
            <div class="content-section">
                ...
                <div class="member-list">
                    <div class="member-item">
                        ...
                        <img src="./img/content/bandmember.jpg" alt="Name" class="member-img">
                    </div>
                    <div class="member-item">
                        <p class="member-name">Name</p>
                        <img src="./img/content/bandmember.jpg" alt="Name" class="member-img">
            ...
            <div class="tour-section">
                ...
                <div class="content-section">
                    ...
                    <div class="place-item">
                        <img src="./img/tour_date/newyork.jpg" alt="New York" class="place-img">
                    ...
                    <div class="place-item">
                        <img src="./img/tour_date/paris.jpg" alt="New York" class="place-img">
                        <div class="place-body">
                    ...
                    <div class="place-item">
                        <img src="./img/tour_date/sanfran.jpg" alt="New York" class="place-img">
                        <div class="place-body">
            ...
            <div class="content-section">
                ...
                <div class="contact-section">
                       ...
                       <p class="contact-heading-section">Chicago, US</p>
                    </div>
                    <div class="contact-section">
                       <i class="ti-location-pin"></i>
                       <p class="contact-heading-section">Chicago, US</p>
